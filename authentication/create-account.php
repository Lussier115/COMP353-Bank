    ...
    <?php include("../includes/header.php"); ?>
        <div class="container" id="main-content">
            ...
            <form  style=" background-color: rgba(255, 255, 255, 0.5);" action = "" method = "post" class = "form-box" id="account">
                ...
                <label>Email Address  :</label><input class="form-control2" type = "email_address" name = "email_address" class = "box"/><br /><br />
                ...
                <label>Date of Birth :</label><input class="form-control2" type = "date" name = "birthday" class = "box"/><br /><br />
