...
$sqlLoss = "SELECT DISTINCT account.balance, interest_rate.kind_of_service FROM interest_rate, account WHERE account.interest_rate_id = interest_rate.interest_rate_id AND (interest_rate.kind_of_service= 'credit' OR interest_rate.kind_of_service= 'line_credit' )";
$resultLoss = mysqli_query($db, $sqlLoss);
$sqlLSum = "SELECT SUM( account.balance) as totalLoss FROM interest_rate, account WHERE account.interest_rate_id = interest_rate.interest_rate_id AND (interest_rate.kind_of_service= 'credit' OR interest_rate.kind_of_service= 'line_credit  ' )";
